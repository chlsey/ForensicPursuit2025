...
label incorrect_label:
    ...
    if label.dipped:
        s normal2 "Remember, set the time for 10 minutes and the temperature in between 100 and 200."
    else:
        s normal2 "Remember, set the time between 0h00 and 1h00 and the temperature between 200 and 300."
    $ on_timer = False
    $ on_temperature = False
